...
//  TwitterTutorial
//
//  Created by Maria Yelfimova on 24/06/2021.
//

import UIKit

// a class dedicated for created repetitive UI-elements
class Utilities {
    ...
    func inputContainerView(withImage image: UIImage, textField: UITextField) -> UIView {
        ...
        dividerView.anchor(left: view.leftAnchor, bottom: view.bottomAnchor, right: view.rightAnchor, paddingLeft: 2, paddingBottom: 1, paddingRight: 2, height: 0.75)
